...
export const LEARNING_ITEMS = Object.freeze([
  ['active','I learn better when I can practise a concept rather than only read or listen to it.'],['visual','Diagrams, demonstrations or visual examples help me understand new ideas.'],['discussion','Talking through an idea with another person helps me develop my understanding.'],['independent','I prefer having time to explore and practise a topic independently.'],['structure','I learn best when the task has clear steps and expectations.'],['feedback','Timely feedback helps me improve how I learn or practise.'],['application','I understand ideas more deeply when I can connect them to real situations.'],['pace','I prefer learning experiences that let me revisit difficult material at my own pace.'],['collaboration','Working with others can improve my learning when the roles are clear.'],['challenge','I enjoy learning activities that require me to solve unfamiliar problems.'],
...
export const SKILL_ITEMS = Object.freeze([
  ['communication','I can explain ideas clearly to people with different levels of knowledge.'],['problemSolving','I can break an unfamiliar problem into smaller steps.'],['digital','I can learn and use digital tools needed for study or work.'],['teamwork','I can contribute reliably when working as part of a team.'],['initiative','I can identify a useful next step without always waiting for instructions.'],['organisation','I can organise tasks, information and deadlines effectively.'],['research','I can find, compare and evaluate information before using it.'],['presentation','I can present my ideas in a structured way.'],['adaptation','I can learn a new method when the previous approach is no longer effective.'],['selfManagement','I can manage my effort and attention across a longer task.'],
