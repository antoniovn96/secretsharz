...
export const STUDENT_PREMIUM_REPORT = Object.freeze([
  ...STUDENT_FREE_REPORT,
  { id: 'developmental_context', title: 'Developmental & Academic Context', purpose: 'Interpret age, education stage, board, subjects, marks and academic context together.' },
  ...
  { id: 'opportunity_plan', title: 'Opportunity Plan', purpose: 'Connect the student to realistic exposure, research, mentoring and experience actions.' },
  { id: 'action_roadmap', title: '90-Day Career Action Roadmap', purpose: 'Convert exploration into measurable actions and milestones.' },
...
export function getReportPages({ tier = 'free', pathway = 'student' } = {}) {
  if (tier !== 'full') return STUDENT_FREE_REPORT;
