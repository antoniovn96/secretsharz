      ...
      <div className="social-dashboard-layout">
        ...
        <aside className="social-sidebar">
          ...
          <ul style={{ listStyle: 'none', padding: 0, color: '#E4E6EB', lineHeight: '2.5', fontWeight: 'bold' }}>
            <li style={{ cursor: 'pointer' }}>👨‍👩‍👧 My Child&apos;s Profile</li>
            <li style={{ cursor: 'pointer' }}>📈 Growth &amp; Reports</li>
            <li style={{ cursor: 'pointer' }}>💳 Billing &amp; Invoices</li>
          </ul>
          ...
          <div style={{ marginTop: '32px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {onBack && (
              <button
                onClick={onBack}
                style={{ width: '100%', padding: '9px', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.15)', borderRadius: '8px', color: '#B0B3B8', fontSize: '12px', fontWeight: '600', cursor: 'pointer', fontFamily: 'inherit' }}
              >
            ...
            {onLogout && (
              <button
                onClick={onLogout}
                style={{ width: '100%', padding: '9px', background: 'transparent', border: 'none', color: '#EF4444', fontSize: '12px', fontWeight: '600', cursor: 'pointer', fontFamily: 'inherit' }}
              >
                Sign Out
              </button>
            )}
        ...
        <main className="social-main-content">
          ...
          {/* ── PHASE 3: EXISTING WIDGETS ── */}
          <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '20px' }}>

            {/* ── XP / Progress Overview ── */}
            <div style={{ background: '#2D2E2F', border: '1px solid #3A3B3C', borderRadius: '16px', padding: '24px' }}>
            ...
            {hasAssessment ? (
              ...
              <div style={{ background: '#2D2E2F', border: '1px dashed #3A3B3C', borderRadius: '16px', padding: '40px', textAlign: 'center' }}>
