...
const CSS = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  .journey-container { display: flex; align-items: center; justify-content: center; overflow-x: auto; padding: 20px 24px 40px; gap: 16px; scrollbar-width: none; -webkit-overflow-scrolling: touch; }
