...
const CSS = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  .hero-h1{font-family:'Fraunces',serif;font-size:clamp(36px,5.5vw,60px);font-weight:700;line-height:1.1;color:var(--ink);letter-spacing:-1.5px;margin-bottom:20px;}
  .hero-h1 em{font-style:italic;color:var(--sage);}
  .hero-sub{font-size:18px;color:var(--ink-soft);line-height:1.6;max-width:600px;font-weight:400;margin-bottom:32px;}
  .hero-checklist{list-style:none;padding:0;margin-bottom:40px;}
  .hero-checklist li{display:flex;align-items:center;gap:10px;font-size:15px;color:var(--ink-soft);margin-bottom:8px;font-weight:600;}
  ...
  .btn-ghost{background:transparent;color:var(--ink-soft);padding:16px 28px;border-radius:50px;font-size:15px;font-weight:600;border:2px solid var(--border);cursor:pointer;font-family:inherit;transition:all 0.2s;display:flex;align-items:center;gap:8px;}
  ...
  .section-eyebrow{font-size:12px;font-weight:700;color:var(--sage);letter-spacing:2px;text-transform:uppercase;margin-bottom:14px;display:block;}
  ...
  .section-p{font-size:17px;color:var(--muted);line-height:1.75;font-weight:400;max-width:680px;}
  .section-header{max-width:700px;margin:0 auto 64px;text-align:center;}
  .section-header .section-p{margin:0 auto;}

  /* ── S.H.A.R.E. Timeline ── */
  .share-grid{display:flex;flex-direction:column;gap:16px;max-width:800px;margin:40px 0 0;}
  .share-item{display:flex;align-items:flex-start;gap:24px;background:white;padding:32px;border-radius:var(--r-md);border:1px solid var(--border);box-shadow:var(--shadow-sm);transition:all 0.3s cubic-bezier(0.25,0.8,0.25,1);}
  .share-item:hover{transform:translateX(12px);border-color:var(--sage);box-shadow:var(--shadow-md);}
  .share-letter{width:56px;height:56px;background:var(--sage-pale);color:var(--sage);border-radius:16px;display:flex;align-items:center;justify-content:center;font-family:'Fraunces',serif;font-size:28px;font-weight:700;flex-shrink:0;}
  .share-text h4{font-size:20px;color:var(--ink);margin-bottom:8px;font-weight:700;display:flex;align-items:center;gap:8px;}
  .share-text p{font-size:15px;color:var(--ink-soft);line-height:1.6;margin:0;}

  /* ── Pillars Grid ── */
  .pillars-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:24px;max-width:1100px;margin:0 auto;}
  .pillar-card{background:white;border-radius:var(--r-md);padding:36px 32px;border:1px solid var(--border);box-shadow:var(--shadow-sm);transition:all 0.3s;position:relative;overflow:hidden;display:flex;flex-direction:column;}
  ...
  /* ── Social Proof ── */
  .social-proof-section{padding:80px 0;overflow:hidden;background:linear-gradient(180deg,transparent,var(--sand));}
  .sp-header{text-align:center;font-size:20px;font-family:'Fraunces',serif;font-weight:700;color:var(--ink);margin-bottom:40px;}
  .sp-slider{display:flex;gap:24px;padding:0 48px 24px;overflow-x:auto;scroll-snap-type:x mandatory;scrollbar-width:none;-ms-overflow-style:none;}
  .sp-slider::-webkit-scrollbar{display:none;}
  .sp-card{background:white;padding:32px;border-radius:var(--r-md);box-shadow:var(--shadow-sm);min-width:340px;max-width:340px;scroll-snap-align:start;flex-shrink:0;border:1px solid var(--border);}
  .sp-stars{color:#F59E0B;font-size:16px;margin-bottom:16px;letter-spacing:2px;}
  .sp-quote{font-size:16px;color:var(--ink-soft);font-style:italic;margin-bottom:20px;line-height:1.6;}
  .sp-author{font-size:12px;font-weight:700;color:var(--muted);text-transform:uppercase;}

  /* ── Origin Story ── */
  .story-section{padding:100px 48px;background:white;display:flex;align-items:center;justify-content:center;gap:80px;flex-wrap:wrap;}
  ...
  .b2b-card{background:rgba(255,255,255,0.05);padding:32px;border-radius:var(--r-md);border:1px solid rgba(255,255,255,0.1);transition:background 0.2s;}
  .b2b-card:hover{background:rgba(255,255,255,0.08);}

  /* ── Privacy/Safe Section ── */
  ...
  .privacy-grid{display:grid;grid-template-columns:1fr 1fr;gap:20px;text-align:left;margin-bottom:60px;}
  .privacy-item{background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);padding:24px;border-radius:16px;display:flex;align-items:flex-start;gap:16px;}
  .privacy-item span{font-size:28px;}
  .privacy-item h4{color:white;margin:0 0 6px 0;font-size:16px;}
  .privacy-item p{color:rgba(255,255,255,0.6);margin:0;font-size:14px;line-height:1.5;}
  ...
  /* ── SHARZ WALL (Keep minimal CSS to support routing) ── */
  ...
  @media(max-width:900px){
    .ss-hero{padding:40px 24px;min-height:auto;}
...
const PILLARS = [
  { cls:'share', icon:'💬', title:'Sharz Wall', desc:"A totally anonymous community board. Share your struggles, read stories from students exactly like you, and give support without the toxicity of normal social media.", features:['100% anonymous sharing','Peer reactions & support','Moderated safe community'], cta:'Read Anonymous Stories →', route:'/wall' },
  { cls:'mind', icon:'🧠', title:'Emotional First Aid', desc:"Over 25 interactive, immediate micro-interventions. From 'Pop the Thoughts' games to 4-7-8 breathing visualizers, find instant relief for anxiety, anger, or burnout.", features:['Interactive breathing visualizers','Cognitive reframing tools','Quick mood resets'], cta:'Try Emotional First Aid →', route:'/mindspace' },
  { cls:'guide', icon:'🎓', title:'VidyaVantage Career Match', desc:"Our premium career subsidiary. Stop guessing your future. Get data-backed career routing based on Holland's RIASEC theory and a database of 500+ Indian colleges.", features:['AI-powered RIASEC test','500+ College Database','Actionable 30-day roadmaps'], cta:'Explore VidyaVantage →', route:'/vidyavantage' },
  { cls:'safe', icon:'🛡️', title:'The Safe Corner', desc:"Immediate crisis escalation. 24/7 access to trained counselors and national helplines like iCall and Vandrevala Foundation. You never have to carry it alone.", features:['24/7 crisis helpline access','Connect with trained counsellors','Report unsafe situations privately'], cta:'View Safety Protocols →', route:'/safe' },
];
    ...
    <>
      ...
      <section className="ss-hero">
        ...
        <div className="hero-content">
          ...
          <h1 className="hero-h1 anim-up-1">The things you can&apos;t tell anyone... <br /><span className="underline-word">you can tell us.</span></h1>
          <p className="hero-sub anim-up-2">
            India&apos;s first anonymous emotional safe space and career discovery platform for youth. No real names. No judgment. Just 100% free support to help you clear your mind and own your future.
          </p>
          <ul className="hero-checklist anim-up-3">
            <li>Takes 30 seconds to start</li>
            <li>Your identity is completely hidden</li>
            <li>Designed by professional counselors</li>
          </ul>
      ...
      <section className="section-alt">
        <div className="section-header">
          ...
          <h2 className="section-h2">We are asking students to figure out their entire future, while they are struggling just to <em>get through the day.</em></h2>
          <p className="section-p" style={{ marginTop: '20px' }}>
            Academic pressure. Family expectations. Social isolation. The weight is heavy, and most students are carrying it alone. At Secret Sharz, we believe in one fundamental truth:
          </p>
          <p className="section-p" style={{ marginTop: '16px', fontWeight: '600', color: 'var(--ink)' }}>
            Mental clarity is the exact prerequisite for career clarity. 
          </p>
          <p className="section-p" style={{ marginTop: '16px' }}>
            You cannot make confident decisions about your future when you are overwhelmed in the present. We fix the foundation first, so you can build the future you actually want.
          </p>
        </div>
      </section>

      {/* SECTION 3: S.H.A.R.E METHODOLOGY */}
      <section className="section" style={{ background: 'var(--sand)' }}>
        <div className="section-header" style={{ marginBottom: '40px' }}>
          <h2 className="section-h2">How it works: The <em>S.H.A.R.E.</em> Journey</h2>
          <p className="section-p">We don&apos;t just give you tools; we guide you through a proven psychological framework to take you from emotional overwhelm to total career confidence.</p>
        </div>
      ...
      <section className="section-alt" style={{ paddingTop: '20px', paddingBottom: '0' }}>
      ...
      <section className="b2b-section">
        ...
        <p className="section-p" style={{ color:'rgba(255,255,255,0.6)' }}>Empower your student body with an anonymous, POCSO-aligned emotional safety net.</p>
        <div className="b2b-grid">
          <div className="b2b-card"><div style={{ fontSize:'32px', marginBottom:'15px' }}>🛡️</div><h3 style={{ fontFamily:'Fraunces, serif', fontSize:'20px', marginBottom:'10px' }}>Early Intervention</h3><p style={{ fontSize:'14px', color:'rgba(255,255,255,0.5)', lineHeight:1.6 }}>Our platform helps students self-regulate before stress turns into a crisis.</p></div>
          <div className="b2b-card"><div style={{ fontSize:'32px', marginBottom:'15px' }}>📊</div><h3 style={{ fontFamily:'Fraunces, serif', fontSize:'20px', marginBottom:'10px' }}>Anonymized Analytics</h3><p style={{ fontSize:'14px', color:'rgba(255,255,255,0.5)', lineHeight:1.6 }}>Gain high-level insights into the emotional health of your school without ever compromising an individual student&apos;s privacy.</p></div>
          <div className="b2b-card"><div style={{ fontSize:'32px', marginBottom:'15px' }}>🤝</div><h3 style={{ fontFamily:'Fraunces, serif', fontSize:'20px', marginBottom:'10px' }}>Seamless Integration</h3><p style={{ fontSize:'14px', color:'rgba(255,255,255,0.5)', lineHeight:1.6 }}>Deploy a complete mental health and career routing infrastructure to thousands of students in under 48 hours.</p></div>
        </div>
        <button className="btn-primary" style={{ marginTop:'40px', background:'white', color:'var(--ink)' }} onClick={() => setModal('talk')}>Schedule a School Demo</button>
      </section>

      {/* SECTION 8: PRIVACY / FINAL PUSH */}
      <section className="safe-section">
        <div className="safe-content">
          <h2 className="section-h2">This is a <em>judgment-free</em> zone. Always.</h2>
          <p className="section-p">Your safety is our only metric.</p>
          ...
          <button className="btn-primary" style={{ padding: '20px 48px', fontSize: '18px' }} onClick={() => navigate(currentUser ? '/dashboard' : '/auth')}>
            Create My Safe Space Now →
          </button>
        </div>
      </section>
    </>
...
function WallPage({ navigate }) {
  ...
  const vulgarWords = ['fuck', 'shit', 'bitch', 'asshole', 'dick', 'pussy', 'cunt', 'slut', 'whore', 'bastard', 'motherfucker', 'crap', 'fag', 'faggot', 'nigger', 'nigga', 'retard', 'retarded'];
  const riskPhrases = ['kill myself', 'want to die', 'end it all', 'give up', 'suicide', "can't take it anymore", 'no reason to live', 'end my life', 'cut myself', 'hurt myself', 'better off dead'];

  const checkSafety = (text) => {
    const lowerText = text.toLowerCase();
    for (let phrase of riskPhrases) {
      if (lowerText.includes(phrase)) return 'CRISIS';
    }
    for (let word of vulgarWords) {
      const regex = new RegExp(`\\b${word}\\b`, 'i'); 
      if (regex.test(lowerText)) return 'VULGAR';
    }
    return 'SAFE';
  };
  ...
  return (
    <div className="wall-page">
      ...
      <div className="wall-header">
        ...
        <div><button className="add-note-btn" onClick={() => { setErrorMsg(''); setShowAddNoteModal(true); }}>✍️ Add Your Note</button></div>
      ...
      {showAddNoteModal && (
        <div className="note-modal-overlay" onClick={() => setShowAddNoteModal(false)}>
          <div className="note-modal" onClick={e => e.stopPropagation()}>
            ...
            {errorMsg && <div className="safety-error">{errorMsg}</div>}
...
export default function App() {
  ...
  const renderRoute = () => {
    ...
    if (currentPath.startsWith('/wall')) {
      return <WallPage navigate={navigate} />;
    }
