...
.lst-chip:hover { border-color:var(--ls-amber); color:var(--ls-amber); background:var(--ls-amber-pale); }
...
const ACTIVITIES = [
  ...
  // ── WHO Skill 1: Self-Awareness ──
  {
    ...
    phases: [
      ...
      { time: "22–30 min", phase: "Pair Activity — Guessing", steps: [ { type: "say", text: "Pair up. Share ONLY your above-waterline with your partner. Do not tell them what is below the line yet." }, { type: "say", text: "Your partner's job is to GUESS what might be below your waterline. Then tell them how close they were." }, { type: "do", text: "Give pairs 5 minutes. Each person shares once." } ] },
      { time: "30–35 min", phase: "Full Class Debrief", steps: [ { type: "say", text: "Let us come back together. I have a few questions for the whole group." }, { type: "do", text: "Use the debrief questions below." } ] }
    ],
    debrief: [ { q: "Was it easy or difficult to look below your waterline? What made it difficult?", note: "Listen for: 'I didn't know what the feeling was'. Validate this." }, { q: "Has someone ever responded to just your tip and completely missed what was really going on?", note: "This is usually the question that creates the most resonance." }, { q: "When your partner guessed your below-waterline feeling correctly, what happened inside you?", note: "Listen for: 'I felt understood', 'relieved'." } ],
    watchOutFor: [ "A student who discloses something serious during the writing. Have your referral process ready.", "Students who write nothing. Do not force participation." ],
    variations: [ { tag: "Grade 5", text: "Use a provided emotion word bank rather than asking students to generate words." }, { tag: "Short session", text: "Remove the pair guessing activity and go straight to debrief." } ],
    worksheet: { title: "The Feelings Iceberg", intro: "Our emotions are like icebergs — a small visible tip and a huge hidden part. Map your own.", sections: [ { title: "My Iceberg", prompts: [ { label: "The situation I am thinking of:", lines: 2 }, { label: "ABOVE THE WATERLINE — What people saw:", lines: 2 }, { label: "BELOW THE WATERLINE — What I was really feeling inside:", lines: 4 } ] }, { title: "Reflection Questions", prompts: [ { label: "Was it easy or hard to look below the waterline? What made it difficult?", lines: 3 }, { label: "One thing I want others to understand about my below-waterline feelings:", lines: 2 } ] } ] }
  },
  {
    id: "l_sa_2", title: "My Strengths Shield", themeShort: ["Self-awareness"], grade: "5–7", gradeKey: "lower", duration: "40 min", formats: ["Individual art activity", "Pairs"], color: "#F1C40F", colorPale: "#FEF9E7", imagePath: "/resources/lifeskills/placeholder.jpg",
  ...
  {
    id: "l_sa_3", title: "The Mirror Game", themeShort: ["Self-awareness"], grade: "5–7", gradeKey: "lower", duration: "30 min", formats: ["Pairs", "Full class"], color: "#F1C40F", colorPale: "#FEF9E7", imagePath: "/resources/lifeskills/placeholder.jpg",
  ...
  },
  {
    ...
    watchOutFor: [ "Students getting too loud or competitive. Keep control of the bidding." ],
    variations: [ { tag: "Grade 7", text: "Use more abstract values like 'Integrity', 'Adventure', or 'Security'." } ],
    worksheet: { title: "My Value Wallet", intro: "What did you buy?", sections: [ { title: "Reflection", prompts: [ { label: "The item I wanted most was:", lines: 1 }, { label: "I wanted it because it represents:", lines: 2 } ] } ] }
  },
  ...
  {
    id: "l_em_2", title: "Walk a Mile — Persona Cards", themeShort: ["Empathy"], grade: "5–7", gradeKey: "lower", duration: "40 min", formats: ["Individual reflection", "Pairs"], color: "#E8845A", colorPale: "#FDF0EA", imagePath: "/resources/lifeskills/placeholder.jpg",
    objective: "Students will practise inhabiting a perspective genuinely different from their own to build empathy.", materials: ["Persona Cards", "Worksheet"],
    phases: [
      ...
      { time: "22–33 min", phase: "Paired Conversation", steps: [ { type: "do", text: "Pair students whose personas are different from each other." }, { type: "say", text: "Have a 5-minute conversation in role. The topic: your school is planning a new policy. Tell each other what that policy should be." } ] },
      { time: "33–40 min", phase: "Debrief", steps: [ { type: "say", text: "Come out of role now. Let us talk about what just happened." }, { type: "do", text: "Use the debrief questions." } ] }
    ],
    debrief: [ { q: "What was the hardest part of staying in your persona's perspective?", note: "This is usually: 'I kept thinking what I would do'." }, { q: "What did you discover about your persona that you would not have guessed just looking at them?", note: "Listen for the insight that internal experience is rich and complicated." } ],
    watchOutFor: [ "A student who gets a persona very similar to their own difficult situation." ],
    variations: [ { tag: "Short session", text: "Skip the paired conversation. Go from individual reflection to group debrief." } ],
    worksheet: { title: "Persona Reflection", intro: "Answer questions 1–2 IN ROLE. Answer questions 3–4 as yourself.", sections: [ { title: "In Role", prompts: [ { label: "1. What does a typical school day feel like for you?", lines: 3 }, { label: "2. What do you worry about most?", lines: 3 } ] }, { title: "As Yourself", prompts: [ { label: "3. What surprised me most about my persona internal experience?", lines: 3 }, { label: "4. One assumption I had before this activity that I want to question:", lines: 2 } ] } ] }
  },
  {
  ...
  },
  {
    ...
    worksheet: { title: "Silent Listening", intro: "Listen with your eyes.", sections: [ { title: "Observation", prompts: [ { label: "What my partner did to show they were listening:", lines: 2 } ] } ] }
  },
  ...
  },
  {
    ...
    worksheet: { title: "Fact-Checker Audit", intro: "Find the trick.", sections: [ { title: "Analysis", prompts: [ { label: "One exaggerated claim I found:", lines: 2 } ] } ] }
  },
  {
    ...
    worksheet: { title: "Logic Check", intro: "Defend your choice.", sections: [ { title: "My Defense", prompts: [ { label: "My choice:", lines: 1 }, { label: "My logical reason:", lines: 2 } ] } ] }
  },
  ...
  },
  {
    ...
    worksheet: { title: "Divergent Thinking", intro: "Break the rules.", sections: [ { title: "The Sprint", prompts: [ { label: "List as many uses as possible:", lines: 4 } ] } ] }
  },
  {
    ...
    worksheet: { title: "Story Building", intro: "Adapt and create.", sections: [ { title: "Reflection", prompts: [ { label: "My favorite twist in the story was:", lines: 2 } ] } ] }
  },
  ...
  },
  {
    ...
    watchOutFor: [ "Groups getting stuck on unrealistic extreme consequences. Keep them grounded." ],
    variations: [ { tag: "Grade 5", text: "Do the mapping as a full class activity on the main whiteboard." } ],
    worksheet: { title: "The What-If Map", intro: "Trace the ripples of your choices.", sections: [ { title: "My Map", prompts: [ { label: "The Decision:", lines: 2 }, { label: "Path A leads to:", lines: 2 }, { label: "Path B leads to:", lines: 2 } ] } ] }
  },
  {
    ...
    debrief: [ { q: "What does a 'bad idea' feel like in your body?", note: "Tight chest, butterflies." } ],
    watchOutFor: [ "Confusing gut feelings with general anxiety. Clarify the difference." ],
    variations: [ { tag: "Quick version", text: "Do a verbal share instead of writing." } ],
    worksheet: { title: "Gut Check", intro: "Listen to your body.", sections: [ { title: "Reflection", prompts: [ { label: "A time I ignored my gut:", lines: 2 }, { label: "How it felt in my body:", lines: 1 } ] } ] }
  },
  ...
  {
    id: "l_ps_3", title: "The Impossible Tower", themeShort: ["Problem solving", "Creative thinking"], grade: "5–7", gradeKey: "lower", duration: "35 min", formats: ["Small groups"], color: "#16A085", colorPale: "#D5F5F0", imagePath: "/resources/lifeskills/placeholder.jpg",
    objective: "Collaborate to build the tallest structure using limited, non-ideal resources.", materials: ["Paper, tape, marshmallows, dry spaghetti"],
    phases: [
      { time: "0–5 min", phase: "The Brief", steps: [ { type: "say", text: "You have 15 minutes to build the tallest freestanding tower using only these items." } ] },
      { time: "5–20 min", phase: "The Build", steps: [ { type: "do", text: "Let them build. Watch for structural failures and how they recover." } ] },
      { time: "20–35 min", phase: "Debrief", steps: [ { type: "say", text: "What did you do when your first idea collapsed?" } ] }
    ],
    debrief: [ { q: "Did you spend too much time planning or too much time building?", note: "Balance is key." } ],
    watchOutFor: [ "Students getting overly frustrated if their tower falls. Reframe failure as data." ],
    variations: [ { tag: "Constraint", text: "No talking allowed during the build." } ],
    worksheet: { title: "Tower Reflection", intro: "Building from failure.", sections: [ { title: "Process", prompts: [ { label: "What went wrong with our first idea?", lines: 2 } ] } ] }
  },

  // ── WHO Skill 7: Effective Communication ──
  {
    id: "l_ec_1", title: "The 'I' Message Maker", themeShort: ["Effective communication", "Coping with emotions"], grade: "5–7", gradeKey: "lower", duration: "35 min", formats: ["Pairs"], color: "#8E44AD", colorPale: "#F5EEF8", imagePath: "/resources/lifeskills/placeholder.jpg",
  ...
  {
    id: "l_ec_3", title: "The Telephone Breakdown", themeShort: ["Effective communication"], grade: "5–7", gradeKey: "lower", duration: "30 min", formats: ["Full class game", "Pairs"], color: "#8E44AD", colorPale: "#F5EEF8", imagePath: "/resources/lifeskills/placeholder.jpg",
    objective: "Experience how messages distort through communication chains and practise strategies for clearer communication.", materials: ["3 pre-written message cards", "Observation checklist"],
    phases: [
      { time: "0–5 min", phase: "First Round (No Rules)", steps: [ { type: "do", text: "Ask 8 students to form a line. Give the first student Message Card 1. Tell them: 'Whisper this once only. No repeats.'" }, { type: "do", text: "Once the message reaches the end, ask the last student to say it aloud. Write it on the board." } ] },
      { time: "5–10 min", phase: "Second Round (With Listening Rules)", steps: [ { type: "say", text: "Let us try again with Message Card 2 — but this time, we add three rules: 1. Ask ONE clarifying question. 2. Repeat back what you heard. 3. Flag if you are unsure." }, { type: "do", text: "Run the second round. Observe how the message changes." } ] },
      { time: "10–18 min", phase: "Analysis", steps: [ { type: "say", text: "Let us figure out WHY messages change. What were people doing or NOT doing that caused the distortion?" } ] },
      { time: "18–26 min", phase: "Pair Practice", steps: [ { type: "do", text: "Pair students. Student A reads a scenario card aloud once. Student B must: clarify, reflect back, then respond." } ] },
      { time: "26–30 min", phase: "Debrief", steps: [ { type: "do", text: "Discuss real world applications of these rules." } ] }
    ],
    debrief: [ { q: "Where exactly in the line did the message change most?", note: "Students usually identify a long complex part, or a gap filled with assumption." }, { q: "Can you think of a real situation where this breakdown happened?", note: "Fights between friends over 'He said she said' are common examples." } ],
    watchOutFor: [ "Students intentionally corrupting the message for laughs. Redirect warmly." ],
    variations: [ { tag: "Grade 5", text: "Use very short, simple messages in Round 1." } ],
    worksheet: { title: "The Telephone Breakdown", intro: "Today we discovered how messages change as they travel.", sections: [ { title: "Observer Checklist", prompts: [ { label: "Where did the message change most?", lines: 2 } ] } ] }
  },

  // ── WHO Skill 8: Interpersonal Relationships ──
  {
    id: "l_ir_1", title: "The Apology Anatomy", themeShort: ["Interpersonal relationships", "Empathy"], grade: "5–7", gradeKey: "lower", duration: "35 min", formats: ["Full class", "Pairs"], color: "#E67E22", colorPale: "#FDEDEC", imagePath: "/resources/lifeskills/placeholder.jpg",
  ...
  {
    id: "l_ir_2", title: "Friendship Fences", themeShort: ["Interpersonal relationships", "Self-awareness"], grade: "5–7", gradeKey: "lower", duration: "35 min", formats: ["Individual", "Full class"], color: "#E67E22", colorPale: "#FDEDEC", imagePath: "/resources/lifeskills/placeholder.jpg",
  ...
  {
    id: "l_ir_3", title: "The Compliment Web", themeShort: ["Interpersonal relationships", "Empathy"], grade: "5–7", gradeKey: "lower", duration: "30 min", formats: ["Full class"], color: "#E67E22", colorPale: "#FDEDEC", imagePath: "/resources/lifeskills/placeholder.jpg",
    objective: "Foster a positive classroom environment through structured peer appreciation.", materials: ["Sticky notes"],
    phases: [
      { time: "0–10 min", phase: "Setup", steps: [ { type: "say", text: "Write your name on a piece of paper and leave it on your desk. We are going to walk around the room." } ] },
      { time: "10–25 min", phase: "The Web", steps: [ { type: "do", text: "Students rotate desks every 60 seconds and must write one genuine compliment on that person's paper." } ] },
      { time: "25–30 min", phase: "Debrief", steps: [ { type: "do", text: "Return to desks and read." } ] }
    ],
    debrief: [ { q: "How did it feel to read your paper?", note: "Validates positive reinforcement." } ],
    watchOutFor: [ "Ensure no negative or sarcastic comments are written. Monitor closely." ],
    variations: [ { tag: "Anonymous", text: "Do it via an anonymous drop box." } ],
    worksheet: { title: "Compliment Log", intro: "What others see.", sections: [ { title: "Reflection", prompts: [ { label: "The compliment that surprised me most:", lines: 2 } ] } ] }
  },

  // ── WHO Skill 9: Coping with Stress ──
  {
    id: "l_cs_1", title: "The Priority Jar", themeShort: ["Coping with stress", "Decision making"], grade: "5–7", gradeKey: "lower", duration: "35 min", formats: ["Demonstration", "Individual"], color: "#27AE60", colorPale: "#E9F7EF", imagePath: "/resources/lifeskills/placeholder.jpg",
  ...
  {
    id: "l_cs_2", title: "The Worry Box", themeShort: ["Coping with stress", "Coping with emotions"], grade: "5–7", gradeKey: "lower", duration: "30 min", formats: ["Individual"], color: "#27AE60", colorPale: "#E9F7EF", imagePath: "/resources/lifeskills/placeholder.jpg",
  ...
  {
    id: "l_cs_3", title: "The Stress Balloon", themeShort: ["Coping with stress", "Coping with emotions"], grade: "5–7", gradeKey: "lower", duration: "30 min", formats: ["Demonstration", "Individual"], color: "#27AE60", colorPale: "#E9F7EF", imagePath: "/resources/lifeskills/placeholder.jpg",
  ...
  {
    id: "l_ce_1", title: "Belly Breathing Buddies", themeShort: ["Coping with emotions", "Coping with stress"], grade: "5–7", gradeKey: "lower", duration: "25 min", formats: ["Individual"], color: "#9B59B6", colorPale: "#F4ECF7", imagePath: "/resources/lifeskills/placeholder.jpg",
  ...
  {
    id: "l_ce_2", title: "The Emotion Log", themeShort: ["Coping with emotions", "Self-awareness"], grade: "5–7", gradeKey: "lower", duration: "30 min", formats: ["Individual"], color: "#9B59B6", colorPale: "#F4ECF7", imagePath: "/resources/lifeskills/placeholder.jpg",
  ...
  // ── WHO Skill 2: Empathy ──
  {
    ...
    phases: [
      { time: "0–10 min", phase: "Algorithm", steps: [ { type: "say", text: "Social media shows you what you already agree with. This is an echo chamber. It makes us think people who disagree with us are crazy because we never hear their side fairly." } ] },
    ...
    debrief: [ { q: "Does understanding an argument mean you have to agree with it?", note: "No. Empathy does not equal agreement. It just equals understanding." } ],
  ...
  // ── WHO Skill 9: Coping with Stress (5 NEW ACTIVITIES INCLUDED HERE) ──
  {
  ...
  // ── WHO Skill 10: Coping with Emotions ──
  {
    ...
    phases: [
      { time: "0–10 min", phase: "Demo", steps: [ { type: "say", text: "If we open a shaken bottle suddenly, it explodes. We need a slow release." }, { type: "do", text: "Slowly release the cap to let the hiss out." } ] },
      { time: "10–25 min", phase: "Mapping", steps: [ { type: "do", text: "Map Warning Signs and Release Valves on the worksheet. 'What does your body do right before you blow up?'" } ] },
      { time: "25–35 min", phase: "Pair Share", steps: [ { type: "say", text: "Share ONE warning sign so your partner can look out for you." } ] }
    ],
    debrief: [ { q: "Which part of your bottle was hardest to identify?", note: "Usually release valves, because we are not taught how to calm down." } ],
    watchOutFor: [ "A student whose explosion pattern involves self-harm. Follow up privately." ],
    variations: [ { tag: "Grade 8", text: "Focus on physical release valves only (running, drawing, breathing)." } ],
  ...
  },
  {
    ...
    phases: [
      { time: "0–10 min", phase: "Neuroscience", steps: [ { type: "say", text: "Putting a precise name to an emotion literally turns down the alarm center in the brain. 'I am mad' is vague. 'I am feeling betrayed' is precise." } ] },
      { time: "10–20 min", phase: "The Wheel", steps: [ { type: "do", text: "Use the Emotion Wheel to trace 'Angry' out to the outer edges like 'Betrayed' or 'Disrespected'." } ] },
      { time: "20–30 min", phase: "Practice", steps: [ { type: "do", text: "Read scenarios and have students find the hyper-specific emotion word for them." } ] }
    ],
...
worksheet: { title: "Name It To Tame It", intro: "Precision brings calm.", sections: [ { title: "My Vocabulary", prompts: [ { label: "Instead of 'Mad', I am actually feeling:", lines: 1 } ] } ] }
  ...
  },
  {
    ...
    phases: [
      { time: "0–10 min", phase: "The Concept", steps: [ { type: "say", text: "Ikigai is a Japanese concept meaning 'reason for being'. It is the intersection of four things: What you love, what you are good at, what the world needs, and what you can be paid for." } ] },
      { time: "10–25 min", phase: "Mapping", steps: [ { type: "do", text: "Students fill out the 4 circles. Reassure them that it is completely okay if the center (the Ikigai) is blank right now." } ] },
      { time: "25–40 min", phase: "Debrief", steps: [ { type: "say", text: "Look at your map. Are you currently aiming for a career path that misses 'what I love' entirely just to get paid? Or missing 'what pays' just to do what you love?" } ] }
    ],
    debrief: [ { q: "Which circle was the hardest to fill out?", note: "Usually 'What the world needs' for this age group." } ],
    watchOutFor: [ "Career anxiety. Remind them Ikigai evolves over a lifetime and does not have to be figured out perfectly at 17." ],
    variations: [ { tag: "Peer Review", text: "Have a close friend fill out the 'what you are good at' circle for them." } ],
  ...
  // ── WHO Skill 2: Empathy ──
  {
    ...
    phases: [
      { time: "0–10 min", phase: "Assignment", steps: [ { type: "say", text: "Pick a topic you feel strongly about. You are going to debate it. But here is the catch: you MUST argue the side you strongly disagree with, and you must do it with total sincerity." } ] },
      { time: "10–25 min", phase: "The Debate", steps: [ { type: "do", text: "Pairs debate for 5 mins each. You only 'win' if you can make the other person say: 'Yes, that is a logical point.'" } ] },
      { time: "25–40 min", phase: "Debrief", steps: [ { type: "say", text: "Did your own view soften after being forced to find the logic in the 'enemy' argument?" } ] }
    ],
    debrief: [ { q: "Did you find any actual logic in the opposing side?", note: "Breaks black-and-white thinking styles." } ],
    watchOutFor: [ "Sarcastic arguments. Force them to be sincere or the exercise fails." ],
    variations: [ { tag: "Full class", text: "Hold a structured podium debate with the whole class acting as the jury." } ],
  ...
  },
  {
    ...
    objective: "Practice completely silent, non-interruptive active listening to build emotional regulation and empathy.", materials: ["None"],
    phases: [
      { time: "0–5 min", phase: "The Rule", steps: [ { type: "say", text: "We usually listen to reply, not to understand. We interrupt to fix the problem. Today, you are forbidden from replying." } ] },
      { time: "5–20 min", phase: "The Triad", steps: [ { type: "do", text: "Speaker talks for 3 minutes about a real stressor. Listener is completely silent. Observer watches for non-verbal cues." } ] },
      { time: "20–30 min", phase: "Rotation", steps: [ { type: "do", text: "Rotate roles so everyone speaks, listens, and observes." } ] },
      { time: "30–35 min", phase: "Debrief", steps: [ { type: "say", text: "Speakers: How did it feel to not be interrupted or 'fixed' for three whole minutes?" } ] }
    ],
    debrief: [ { q: "Why do we feel the need to jump in with advice so quickly?", note: "It is often about the listener's comfort with silence, not the speaker's needs." } ],
    watchOutFor: [ "Listeners nodding too aggressively or making exaggerated empathetic faces to compensate for silence." ],
    variations: [ { tag: "Summarize", text: "Add 1 minute where the Listener just summarizes what they heard without adding advice." } ],
    worksheet: { title: "Silence and Support", intro: "Practice the pause.", sections: [ { title: "Observation", prompts: [ { label: "What I noticed when I had to stay completely silent:", lines: 2 } ] } ] }
  },
  ...
  // ── WHO Skill 3: Critical Thinking ──
  {
    ...
    phases: [
      { time: "0–10 min", phase: "Setup", steps: [ { type: "say", text: "A student's ambiguous post from 3 years ago has resurfaced. You are the college admissions committee reviewing it." }, { type: "do", text: "Distribute Prosecution, Defence, Witness, and Jury roles." } ] },
      { time: "10–25 min", phase: "The Trial", steps: [ { type: "do", text: "Prosecution and Defence argue. Witnesses speak. Jury decides if the post reflects current character." } ] },
      { time: "25–40 min", phase: "Real Talk", steps: [ { type: "say", text: "Admissions officers and employers do check socials. What are your personal standards for posting now?" }, { type: "do", text: "Have students draft their own digital rules." } ] }
    ],
    debrief: [ { q: "Where is the line between intent and impact online?", note: "Intention does not matter if the public impact is harmful." } ],
    watchOutFor: [ "Defensive posturing from students who post similar things. Keep it objective." ],
    variations: [ { tag: "Future Self", text: "The main witness is the 25-year-old version of the student facing job loss." } ],
    worksheet: { title: "Digital Standards", intro: "Curate your future.", sections: [ { title: "My Rules", prompts: [ { label: "My 3 non-negotiable rules for posting online:", lines: 3 } ] } ] }
  },
  {
    id: "s_ct_2", title: "The Logical Fallacy Hunt", themeShort: ["Critical thinking", "Effective communication"], grade: "11–12", gradeKey: "upper", duration: "40 min", formats: ["Pairs"], color: "#2C3E50", colorPale: "#EAF0FB", imagePath: "/resources/lifeskills/placeholder.jpg",
    objective: "Identify Ad Hominem, Straw Man, and Slippery Slope fallacies in media to immunize against manipulation.", materials: ["Fallacy cheat sheet", "Articles"],
    phases: [
      { time: "0–10 min", phase: "The Fallacies", steps: [ { type: "do", text: "Explain the 3 main fallacies with real-world, non-political examples." } ] },
      { time: "10–25 min", phase: "The Hunt", steps: [ { type: "do", text: "Pairs read opinion articles and highlight the logical errors in the arguments." } ] },
      { time: "25–40 min", phase: "Debrief", steps: [ { type: "say", text: "How can you use these fallacies to spot when someone is losing an argument?" } ] }
    ],
    debrief: [ { q: "Why are Straw Man arguments so common in online debates?", note: "It is much easier to defeat a fake, exaggerated argument than a complex real one." } ],
    watchOutFor: [ "Class turning into a partisan political fight. Keep focus heavily on the LOGIC, not the topic." ],
    variations: [ { tag: "Video", text: "Use clips from evening news debates instead of text." } ],
    worksheet: { title: "Fallacy Hunt", intro: "Spot the error.", sections: [ { title: "Findings", prompts: [ { label: "The clearest logical fallacy I found was:", lines: 2 } ] } ] }
  },
  ...
  // ── WHO Skill 4: Creative Thinking ──
  {
    ...
    phases: [
      { time: "0–10 min", phase: "Anti-Brainstorm", steps: [ { type: "say", text: "We need to plan the senior farewell. Give me the absolute WORST, most disastrous ideas possible." }, { type: "do", text: "Write them all on the board without judgment." } ] },
      { time: "10–20 min", phase: "The Flip", steps: [ { type: "say", text: "Now, pick one terrible idea. How could we tweak it, or do the exact opposite, to make it actually work brilliantly?" } ] },
      { time: "20–30 min", phase: "Debrief", steps: [ { type: "do", text: "Discuss why bad ideas unlock the brain's creative 'safe' mode." } ] }
    ],
    debrief: [ { q: "Why was it easier to come up with bad ideas?", note: "Zero fear of judgment allows for rapid divergent thinking." } ],
    watchOutFor: [ "Inappropriate ideas. Set boundaries early." ],
    variations: [ { tag: "Career", text: "Apply this to 'The worst possible career choice for me'." } ],
  ...
  {
    id: "s_crt_2", title: "Paradigm Shift", themeShort: ["Creative thinking", "Decision making"], grade: "11–12", gradeKey: "upper", duration: "35 min", formats: ["Small groups"], color: "#F1C40F", colorPale: "#FEF9E7", imagePath: "/resources/lifeskills/placeholder.jpg",
    objective: "Solve a problem by explicitly changing the underlying assumptions.", materials: ["Scenario cards"],
    phases: [
      { time: "0–10 min", phase: "Assumption Check", steps: [ { type: "say", text: "If you assume school must happen in a building, you design one way. If you drop that assumption, you design online learning. That is a paradigm shift." } ] },
      ...
      { time: "25–35 min", phase: "Debrief", steps: [ { type: "say", text: "What 'rules' of life are actually just assumptions?" } ] }
    ],
    debrief: [ { q: "What is one rule in your life you have never questioned until today?", note: "Encourages challenging the status quo." } ],
    watchOutFor: [ "Groups getting stuck on logistics. Tell them to dream big and ignore reality for a moment." ],
    variations: [ { tag: "Personal", text: "Apply this to their own post-school plans." } ],
  ...
  // ── WHO Skill 5: Decision Making ──
  {
    ...
    objective: "Analyze a complex moral scenario, separate emotion from logic, and articulate a defensible decision.", materials: ["Dilemma Case Studies"],
    phases: [
      { time: "0–10 min", phase: "The Scenario", steps: [ { type: "do", text: "Read a dilemma where a friend cheats to keep a scholarship. If you tell, they lose it. If not, honest students are penalized." } ] },
      { time: "10–25 min", phase: "Deliberation", steps: [ { type: "say", text: "Your group must reach a consensus. No one can stay neutral or abstain." } ] },
      { time: "25–40 min", phase: "Debrief", steps: [ { type: "do", text: "Groups present their logic. Discuss the difference between easy and right." } ] }
    ],
    debrief: [ { q: "What argument almost changed your mind?", note: "Builds respect for nuance." } ],
    watchOutFor: [ "Finding loopholes. Force the hard choice; do not let them invent a magical third option." ],
    variations: [ { tag: "Workplace", text: "Use corporate ethics or medical ethics scenarios." } ],
    worksheet: { title: "Moral Logic", intro: "Break down the hard choices.", sections: [ { title: "Analysis", prompts: [ { label: "Who gets hurt if I take Action A?", lines: 2 }, { label: "Who gets hurt if I take Action B?", lines: 2 }, { label: "My final decision and why:", lines: 3 } ] } ] }
  },
  {
    id: "s_dm_2", title: "Regret Minimization Framework", themeShort: ["Decision making"], grade: "11–12", gradeKey: "upper", duration: "35 min", formats: ["Individual"], color: "#2980B9", colorPale: "#EBF5FB", imagePath: "/resources/lifeskills/placeholder.jpg",
    ...
    phases: [
      ...
      { time: "10–25 min", phase: "Writing", steps: [ { type: "do", text: "Students pick a real upcoming choice (e.g., college path, a difficult conversation) and write the 80-year-old perspective." } ] },
  ...
  // ── WHO Skill 6: Problem Solving ──
  {
    id: "s_ps_1", title: "Root Cause Analysis (5 Whys)", themeShort: ["Problem solving", "Critical thinking"], grade: "11–12", gradeKey: "upper", duration: "35 min", formats: ["Pairs"], color: "#16A085", colorPale: "#D5F5F0", imagePath: "/resources/lifeskills/placeholder.jpg",
    objective: "Apply a business framework to find the root cause of a personal or academic failure.", materials: ["Whiteboard"],
    phases: [
      { time: "0–10 min", phase: "The Logic", steps: [ { type: "say", text: "Asking Why 5 times finds the bad motor, not just the broken belt. We apply this to our own lives." } ] },
      { time: "10–25 min", phase: "Deep Dive", steps: [ { type: "do", text: "Pairs take an academic problem (e.g., 'I failed the mock exam'). Ask Why 5 times down to the emotional root (e.g., 'I am terrified of looking stupid so I don't ask for help')." } ] },
      { time: "25–35 min", phase: "The Fix", steps: [ { type: "do", text: "Design a solution for the actual root, not the surface." } ] }
    ],
    debrief: [ { q: "How painful was it to reach the 5th Why?", note: "Usually hits a highly vulnerable truth." } ],
    watchOutFor: [ "Stopping at 'I am lazy'. Lazy is a symptom. Ask: 'Why are you avoiding the work?'" ],
    variations: [ { tag: "Group", text: "Apply this to a systemic school problem." } ],
    worksheet: { title: "Root Cause", intro: "Dig deep.", sections: [ { title: "The 5 Whys", prompts: [ { label: "Root Cause (Why #5):", lines: 2 } ] } ] }
  },
  {
    ...
    objective: "Anticipate failure before it happens to build robust contingency plans for board exams or admissions.", materials: ["Worksheet"],
    phases: [
      { time: "0–10 min", phase: "Assume Failure", steps: [ { type: "say", text: "A post-mortem is figuring out why something died. A PRE-mortem is assuming your plan died, and figuring out why BEFORE you start." } ] },
      { time: "10–20 min", phase: "The Disaster", steps: [ { type: "say", text: "Assume it is May. You failed your goal completely. Write down exactly what went wrong in March and April." } ] },
      { time: "20–35 min", phase: "Safety Nets", steps: [ { type: "do", text: "Now build the safety nets to stop those specific failures from happening today." } ] }
    ],
    debrief: [ { q: "Did visualizing the failure make you more or less stressed?", note: "Usually less, because the uncertainty is removed." } ],
    watchOutFor: [ "Spiraling anxiety. Ensure you spend the majority of the time on 'The Fix' rather than the failure." ],
    variations: [ { tag: "Pairs", text: "Review each other's blind spots." } ],
  ...
  // ── WHO Skill 7: Effective Communication ──
  {
    id: "s_ec_1", title: "The Blind Architect", themeShort: ["Effective communication", "Interpersonal relationships"], grade: "11–12", gradeKey: "upper", duration: "40 min", formats: ["Teams of 4-5"], color: "#8E44AD", colorPale: "#F5EEF8", imagePath: "/resources/lifeskills/placeholder.jpg",
    objective: "Experience information asymmetry and practice facilitative vs directive leadership.", materials: ["Building materials", "Screens"],
    phases: [
      { time: "0–15 min", phase: "Directive", steps: [ { type: "say", text: "Round 1: Architect TELLS builders exactly what to do. No questions allowed." }, { type: "do", text: "Run 10 mins. Compare results." } ] },
      { time: "15–30 min", phase: "Facilitative", steps: [ { type: "say", text: "Round 2: Architect INVITES ideas. 'What do you think goes next?'" }, { type: "do", text: "Run 8 mins." } ] },
    ...
    watchOutFor: [ "Architects giving up in frustration when builders make mistakes." ],
    variations: [ { tag: "No materials", text: "Use drawing instructions instead of physical building blocks." } ],
  ...
  {
    id: "s_ec_2", title: "STATE Difficult Conversations", themeShort: ["Effective communication", "Coping with emotions"], grade: "11–12", gradeKey: "upper", duration: "40 min", formats: ["Pairs"], color: "#8E44AD", colorPale: "#F5EEF8", imagePath: "/resources/lifeskills/placeholder.jpg",
    objective: "Use the STATE framework (Share facts, Tell story, Ask) to handle high-emotion confrontations.", materials: ["STATE cheat sheet"],
    phases: [
      { time: "0–10 min", phase: "Facts vs Story", steps: [ { type: "say", text: "Crucial conversations fail when we start with emotion. Start with facts. 'I noticed X. It makes me think Y. What is your perspective?'" } ] },
      { time: "10–25 min", phase: "Scripting", steps: [ { type: "do", text: "Pairs draft a STATE script for confronting a friend who lied or pulled away." } ] },
      { time: "25–40 min", phase: "Role-Play", steps: [ { type: "do", text: "Deliver scripts. Partner responds defensively. Practice staying calm." } ] }
    ],
    debrief: [ { q: "Why is it hard to stay on the facts without assigning blame?", note: "Brains assign motive instantly to protect us." } ],
    watchOutFor: [ "Aggressive tone during the role-play. Focus on neutrality." ],
    variations: [ { tag: "Parents", text: "Write a script for negotiating with parents about college choices." } ],
    worksheet: { title: "STATE Framework", intro: "Facts first.", sections: [ { title: "The Script", prompts: [ { label: "The Facts (What a camera saw):", lines: 2 }, { label: "The Ask (Getting their side):", lines: 1 } ] } ] }
  },

  // ── WHO Skill 8: Interpersonal Relationships ──
  {
    id: "s_ir_1", title: "Attachment Styles Workshop", themeShort: ["Interpersonal relationships", "Self-awareness"], grade: "11–12", gradeKey: "upper", duration: "40 min", formats: ["Individual"], color: "#E67E22", colorPale: "#FDEDEC", imagePath: "/resources/lifeskills/placeholder.jpg",
    objective: "Understand relational triggers based on basic psychological attachment theory.", materials: ["Profile sheets"],
    phases: [
      { time: "0–15 min", phase: "Theory", steps: [ { type: "say", text: "Under stress, Anxious types cling. Avoidant types run. Secure types communicate. Which are you?" } ] },
      { time: "15–30 min", phase: "Diagnosis", steps: [ { type: "do", text: "Students read the profiles and circle traits they heavily identify with." } ] },
      { time: "30–40 min", phase: "The Fix", steps: [ { type: "say", text: "If you run, practice staying. If you cling, practice self-soothing." } ] }
    ],
    debrief: [ { q: "Does knowing this make you more empathetic to a friend who pulls away?", note: "Builds immense relational empathy." } ],
    watchOutFor: [ "Students diagnosing their parents. Keep it focused purely on their own behaviors." ],
    variations: [ { tag: "Movie Characters", text: "Diagnose characters in a popular film first to make it less personal." } ],
  ...
  {
    id: "s_ir_2", title: "Boundaries 101", themeShort: ["Interpersonal relationships", "Effective communication"], grade: "11–12", gradeKey: "upper", duration: "35 min", formats: ["Pairs"], color: "#E67E22", colorPale: "#FDEDEC", imagePath: "/resources/lifeskills/placeholder.jpg",
    objective: "Articulate healthy boundaries in high school dating and friendships.", materials: ["Whiteboard"],
    phases: [
      { time: "0–10 min", phase: "The Fences", steps: [ { type: "say", text: "Porous = no fence. Rigid = a brick wall. Healthy = a fence with a gate that you control." } ] },
      { time: "10–25 min", phase: "Scenarios", steps: [ { type: "do", text: "Write the Porous, Rigid, and Healthy response to: 'A partner demands your phone password'." } ] },
      { time: "25–35 min", phase: "Role-Play", steps: [ { type: "do", text: "Practice delivering the Healthy boundary verbally." } ] }
    ],
    debrief: [ { q: "Why is 'no' a complete sentence?", note: "You don't always owe an exhausting explanation." } ],
    watchOutFor: [ "Victim blaming in toxic scenarios. Clarify that bad behavior is solely on the perpetrator." ],
    variations: [ { tag: "Digital", text: "Apply this to location-tracking apps (Snap Maps, Life360)." } ],
  ...
  // ── WHO Skill 9: Coping with Stress ──
  {
    id: "s_cs_1", title: "The Burnout Audit", themeShort: ["Coping with stress", "Self-awareness"], grade: "11–12", gradeKey: "upper", duration: "35 min", formats: ["Individual"], color: "#27AE60", colorPale: "#E9F7EF", imagePath: "/resources/lifeskills/placeholder.jpg",
    objective: "Identify symptoms of burnout versus acute stress, and map energy drains and gains.", materials: ["Audit worksheet"],
    phases: [
      { time: "0–10 min", phase: "Stress vs Burnout", steps: [ { type: "say", text: "Stress is caring too much. Burnout is not having enough energy to care at all. It is physical, not just mental." } ] },
    ...
    debrief: [ { q: "Is scrolling on your phone a + or - for energy?", note: "Usually a '-' in disguise. It numbs, but doesn't recharge." } ],
    watchOutFor: [ "High-achieving students normalizing severe burnout. Challenge the 'grind' culture." ],
    variations: [ { tag: "Grade 12", text: "Do this 2 months before board exams as a preventative measure." } ],
    worksheet: { title: "Energy Audit", intro: "Check your nervous system.", sections: [ { title: "Audit", prompts: [ { label: "My biggest energy drain (-):", lines: 1 }, { label: "My non-negotiable recharge (+):", lines: 1 } ] } ] }
  },
  {
    id: "s_cs_2", title: "The Stress Mindset Reframe", themeShort: ["Coping with stress", "Coping with emotions"], grade: "11–12", gradeKey: "upper", duration: "35 min", formats: ["Full class"], color: "#27AE60", colorPale: "#E9F7EF", imagePath: "/resources/lifeskills/placeholder.jpg",
    objective: "Shift from viewing stress as a threat to viewing it as a biological performance enhancer.", materials: ["Whiteboard"],
    phases: [
      { time: "0–10 min", phase: "The Biology", steps: [ { type: "say", text: "Heart racing = oxygen for the brain. Reframe stress as biological preparation for a challenge." } ] },
      { time: "10–20 min", phase: "The Flip", steps: [ { type: "do", text: "Flip 'I am stressed' to 'My body is preparing me to perform'." } ] },
      { time: "20–35 min", phase: "Application", steps: [ { type: "do", text: "Apply this reframe to their biggest current academic stressor." } ] },
      { time: "35–40 min", phase: "Debrief", steps: [ { type: "say", text: "How does changing the story change the physical feeling in your chest?" } ] }
    ],
    debrief: [ { q: "Can stress ever be a good thing?", note: "Yes, it creates focus and drive if channelled correctly." } ],
    watchOutFor: [ "Invalidating chronic, toxic stress (like abuse). Acknowledge the difference between acute challenge stress and chronic trauma." ],
    variations: [ { tag: "Athletics", text: "Apply this specifically to sports performance anxiety." } ],
  ...
  {
    id: "s_ce_2", title: "Radical Acceptance", themeShort: ["Coping with emotions", "Decision making"], grade: "11–12", gradeKey: "upper", duration: "35 min", formats: ["Individual"], color: "#9B59B6", colorPale: "#F4ECF7", imagePath: "/resources/lifeskills/placeholder.jpg",
    ...
    phases: [
      ...
      { time: "25–35 min", phase: "Next Steps", steps: [ { type: "say", text: "Acceptance doesn't mean you like it. What is your next constructive step now that you accept the past?" } ] }
    ],
    debrief: [ { q: "Does accepting reality mean giving up?", note: "No, it is the starting point for actual progress." } ],
    watchOutFor: [ "Applying this to ongoing abuse. Radical acceptance is for the past/unchangeable, not for tolerating current harm." ],
    variations: [ { tag: "College Rejections", text: "Crucial for application season." } ],
