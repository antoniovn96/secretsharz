...
const PAGE_CSS = `
  ...
  * { box-sizing: border-box; }
  ...
  /* ── TOPBAR ── */
  .abt-topbar { background: var(--ink); color: white; height: 56px; padding: 0 40px; display: flex; align-items: center; justify-content: space-between; position: sticky; top: 0; z-index: 300; border-bottom: 3px solid var(--sage); }
  .abt-back { display: flex; align-items: center; gap: 6px; color: rgba(255,255,255,0.7); font-size: 13px; font-weight: 700; background: none; border: none; cursor: pointer; font-family: inherit; padding: 0; transition: color 0.2s; }
  .abt-back:hover { color: white; }
  .abt-topbar-title { font-family: 'Fraunces', serif; font-size: 16px; color: white; }
  ...
  .abt-btn { padding: 16px 32px; border-radius: 50px; font-size: 16px; font-weight: 700; cursor: pointer; border: none; transition: all 0.2s; display: inline-flex; align-items: center; gap: 8px; font-family: inherit; }
    ...
    <>
      ...
      <div className="abt-page">
        ...
        <div className="abt-topbar">
          <button className="abt-back" onClick={() => navigate && navigate('/')}>← Back to Home</button>
        ...
        <section className="abt-hero">
          <div className="abt-hero-inner">
            ...
            <h1 className="abt-h1">Mental clarity is the prerequisite for <em>career clarity.</em></h1>
        ...
        <section className="abt-section">
          <div className="abt-story-grid">
            <div>
              <h2 className="abt-section-title">Built from real conversations behind closed doors.</h2>
              <p className="abt-text">
                Secret Sharz didn’t start in a tech boardroom; it started in a school counseling office.
              </p>
              <p className="abt-text">
                Day in and day out, the same pattern repeated itself: brilliant, capable students would walk through the door and finally let their guard down. Away from the pressure of grades and the watchful eyes of their peers, the truth came out. They were struggling silently under the crushing weight of expectations. They were paralyzed by anxiety about their futures.
              </p>
              <p className="abt-text">
                Students didn't lack the vocabulary to express their feelings; they lacked a safe, judgment-free place to do it. We expect young people to figure out their entire lives—to choose the perfect stream, score top marks, and pick a lifelong career—while they are actively struggling just to regulate their daily emotions. We were asking them to build a house while the ground was shaking beneath them.
              </p>
              <p className="abt-text" style={{ fontWeight: 700, color: 'var(--sage)', fontSize: '18px' }}>
                Secret Sharz was born to stop the shaking.
              </p>
              <p className="abt-text">
                We took the safety, empathy, and psychological tools of that physical counseling room and scaled it digitally.
              </p>
            </div>
            <div className="abt-story-card">
              <p style={{ fontSize: '18px', lineHeight: 1.6, marginBottom: '32px', position: 'relative', zIndex: 1 }}>
                "We cannot demand career clarity from a mind that is consumed by emotional survival. We have to fix the foundation first."
              </p>
        ...
        {/* Dual Engine Section */}
        <section className="abt-section" style={{ background: 'var(--sand)', borderRadius: '32px', padding: '80px 48px' }}>
          <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
            <span className="abt-eyebrow">The Ecosystem</span>
            <h2 className="abt-section-title">The Dual-Engine Approach</h2>
            <p className="abt-text">
              We realize that healing isn't the final destination; it’s the launchpad. That is why our platform operates as a dual-engine system.
            </p>
          </div>
          
          <div className="abt-dual-grid">
            <div className="abt-engine-card">
              <div className="abt-engine-icon">🛡️</div>
              <div className="abt-engine-tag">1. The Anchor</div>
              <h3 className="abt-engine-title">Secret Sharz</h3>
              <p className="abt-text">
                A radically anonymous sanctuary where identities don't matter, but feelings do. It is a place for students to drop the heavy bags they carry all day, use clinical micro-interventions (Emotional First Aid) to calm their nervous systems, and realize through our anonymous community wall that they are never alone.
              </p>
            </div>
            
            <div className="abt-engine-card" style={{ borderColor: 'rgba(232,132,90,0.3)' }}>
              <div className="abt-engine-icon">🚀</div>
              ...
              <p className="abt-text">
                Once a student clears the noise from their mind, they finally have the space to figure out who they actually are. VidyaVantage is our premium career guidance subsidiary. It takes emotionally regulated students and maps their true personality (via Holland's RIASEC theory) to data-backed college and career pathways.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* S.H.A.R.E. Methodology */}
        <section className="abt-share-wrap">
          <div style={{ textAlign: 'center' }}>
            <span className="abt-eyebrow">Our Framework</span>
            <h2 className="abt-section-title">The S.H.A.R.E. Methodology</h2>
            <p className="abt-text" style={{ maxWidth: '700px', margin: '0 auto' }}>
              Everything we build is guided by our proprietary psychological framework, designed to take a student from emotional overwhelm to unshakeable confidence.
            </p>
          </div>
          
          <div className="abt-share-grid">
            <div className="abt-share-item">
              <div className="abt-share-letter">S</div>
              <div className="abt-share-content">
                <h4>🗣️ Speak (The Secret)</h4>
                <p>Let out hidden thoughts safely and anonymously on the Sharz Wall.</p>
              </div>
            </div>
            <div className="abt-share-item">
              <div className="abt-share-letter">H</div>
              <div className="abt-share-content">
                <h4>🌿 Heal (The First Aid)</h4>
                <p>Regulate your nervous system using our Mind Space tools.</p>
              </div>
            </div>
            <div className="abt-share-item">
              <div className="abt-share-letter">A</div>
              <div className="abt-share-content">
                <h4>🧠 Assess (The Transition)</h4>
                <p>Discover how your unique brain works through our SEN resources and learning profiles without judgment.</p>
              </div>
            </div>
            <div className="abt-share-item">
              <div className="abt-share-letter">R</div>
              <div className="abt-share-content">
                <h4>🗺️ Route (The Strategy)</h4>
                <p>Use VidyaVantage to map your personality to the exact colleges and careers that fit you best.</p>
              </div>
            </div>
            <div className="abt-share-item">
              <div className="abt-share-letter">E</div>
              <div className="abt-share-content">
                <h4>🚀 Empower (The Outcome)</h4>
                <p>Step into your future using actionable roadmaps and unshakeable confidence.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="abt-section">
          ...
          <div className="abt-values-grid">
            <div className="abt-value-card">
              <div className="abt-value-title">🎭 Radical Anonymity</div>
              <p className="abt-text" style={{ fontSize: '15px' }}>We believe true vulnerability requires safety. Real names are never used here.</p>
            </div>
            <div className="abt-value-card" style={{ borderTopColor: 'var(--lavender)' }}>
              <div className="abt-value-title">⚖️ Zero Judgment</div>
              <p className="abt-text" style={{ fontSize: '15px' }}>We provide a space free from toxic positivity and comparison. Every feeling is valid.</p>
            </div>
            <div className="abt-value-card" style={{ borderTopColor: 'var(--peach)' }}>
              <div className="abt-value-title">🛡️ Proactive, Not Reactive</div>
              <p className="abt-text" style={{ fontSize: '15px' }}>We don't wait for a breaking point. We provide early-intervention tools for daily emotional regulation.</p>
            </div>
            <div className="abt-value-card" style={{ borderTopColor: 'var(--sky)' }}>
              <div className="abt-value-title">🧩 Holistic Potential</div>
              <p className="abt-text" style={{ fontSize: '15px' }}>A student is more than their marks. We champion neurodiversity and provide tailored SEN resources so every mind can thrive.</p>
            </div>
          </div>
        </section>
        ...
        <section className="abt-impact">
          ...
          <h2 className="abt-section-title">Aligned with the UN SDGs</h2>
          <p className="abt-text">
            Secret Sharz is proud to align our mission with the United Nations Sustainable Development Goals (SDGs) by democratizing access to psychological first aid and foundational career discovery for all youth.
          </p>
          ...
          <div className="abt-cta-box">
            ...
            <div className="abt-btn-group">
              <button className="abt-btn abt-btn-primary" onClick={() => navigate && navigate('/auth')}>
                Join the Safe Space Today →
              </button>
              <button className="abt-btn abt-btn-secondary" onClick={() => window.location.href = "mailto:antonio.antonio.noronha@gmail.com?subject=School Partnership Inquiry"}>
