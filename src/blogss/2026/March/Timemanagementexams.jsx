...
export default function TimeManagementExams({ navigate, relatedPosts }) {
  return (
    <BlogPostTemplate meta={meta} navigate={navigate} relatedPosts={relatedPosts}>
      ...
      <p><strong>3. The Backward Planning Method (for deadline pressure).</strong> Start from the exam date and work backward. Identify the last possible day to learn genuinely new material (usually 3-4 days before the exam — after this, consolidation and practice are more valuable than new learning). Identify the last day for first-pass coverage of all topics (at least 40% of your preparation window). Map specific topics to specific days working backward from these milestones. Backward planning reveals bottlenecks — places where the plan is impossible — that forward planning hides until it is too late.</li></p>
