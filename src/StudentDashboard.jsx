...
.db-social-layout { display: grid; grid-template-columns: 280px 1fr 300px; gap: 20px; max-width: 1280px; margin: 0 auto; padding: 24px 20px; align-items: start; }
        ...
        <div className="db-card">
          ...
          <div className="db-card-body">
            <div style={{ background: "linear-gradient(135deg, var(--ink), #1C2850)", borderRadius: "var(--r-lg)", padding: "32px", marginBottom: "24px", color: "white" }}>
              <div style={{ fontSize: "12px", color: "rgba(255,255,255,0.4)", fontWeight: "700", letterSpacing: "1.5px", textTransform: "uppercase", marginBottom: "8px" }}>RIASEC Career Report — {String(studentName)}</div>
              <div style={{ fontFamily: "Fraunces, serif", fontSize: "36px", fontWeight: "700", color: "var(--gold)", marginBottom: "8px" }}>{String(localUserData?.riasecCode || "Pending")}</div>
