...
import { 
  ...
  Settings, Shield, LogOut, ChevronRight, Activity,
  FileText, GraduationCap, UserCheck
} from 'lucide-react';
      ...
      <div className="p-4 border-t border-slate-800">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-400 truncate">{user?.email || 'admin@secretsharz.com'}</p>
          </div>
        </div>
        <button
          onClick={onLogout}
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-slate-800 hover:bg-red-500/10 text-slate-400 hover:text-red-400 transition-all duration-200 font-medium text-sm"
        >
