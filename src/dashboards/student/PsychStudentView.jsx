  ...
  return (
    <div className="flex min-h-screen bg-teal-50">
      ...
      <div className="w-64 flex-shrink-0 p-6">
        <div className="bg-white rounded-xl shadow-sm overflow-hidden flex flex-col border border-teal-100">
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-teal-100">
              ...
              <div className="bg-teal-50 rounded-lg p-4 flex flex-col items-start border border-teal-100">
                ...
                <button className="px-4 py-2 bg-teal-600 text-white text-sm font-bold rounded-lg hover:bg-teal-700 transition-colors">
                  Book a Session
                </button>
              </div>
            </div>
