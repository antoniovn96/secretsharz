...
import { STUDENT_CAREER_ADMIN_CONTRACT, buildInstitutionCareerReflection, readInstitutionCareerExploration } from '../../src/institution/careerReportDataContract.js';
...
assert.equal(STUDENT_PREMIUM_REPORT.length, 20, 'Canonical Student premium report must contain 20 sections');
...
assert.equal(byId.has('career_directions'), false, 'Career exploration supporting output must not inflate canonical premium coverage');
assert.equal(readInstitutionCareerExploration(studentReport).length, 1);
